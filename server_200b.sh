...
run() {
    ...
    if [ "$storage" = "leveldb" ];then
        rm -rf /opt/leveldb/data && mkdir -p /opt/leveldb/data
    fi
...
cd ${TEST_TOOL_PATH}
run leveldb 200b_1G 320 5 2000 671089 && sleep 30
echo finish && date

##### mongodb 200b/op, total 1G
cd ${TEST_TOOL_PATH}
run mongodb 200b_1G 320 5 2000 671089 && sleep 30
echo finish && date
...
cd ${TEST_TOOL_PATH}
run mongodb 200b_16G 320 5 2000 10737418 && sleep 30
echo finish && date
...
cd ${TEST_TOOL_PATH}
run leveldb 200b_256G 320 5 2000 171798692 && sleep 30
echo finish && date

##### mongodb 200b/op, total 256G
cd ${TEST_TOOL_PATH}
run mongodb 200b_256G 320 5 2000 171798692 && sleep 30
echo finish && date
